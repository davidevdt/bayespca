...
// mainBayesPCA
Rcpp::List mainBayesPCA(arma::mat X, int D, int I, int J, int nstart, int maxIter, double tolerance, bool svdStart, bool verbose, bool updatetau, std::string priorvar, arma::vec alphatau, arma::vec betatau, arma::vec gammatau, arma::vec deltatau, bool SVS, arma::vec priorInclusion, arma::vec beta1pi, arma::vec beta2pi, double v0, bool commonpi, int JD, arma::mat invTau, double qz, bool scaleprior, std::string hypertype, bool globalvar, bool hpdi);
