...
the number of components supported by the data is uncertain (elbow method - see Figure 2): 


```{r, fig.cap = "Elbow method for 10 components. "}
...
```{r, fig.show='hold', fig.cap = "True and Estimated inclusion probabilities.", fig.width=7, fig.height=5}
