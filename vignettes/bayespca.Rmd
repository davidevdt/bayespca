...
```{r, fig.cap = "Prior variances for the first 3 components.", warning = FALSE}
...
```{r, fig.cap = "Prior variances for 10 components.", warning = FALSE}
...
```{r, fig.show='hold', fig.cap = "High posterior density intervals.", warning = FALSE}
...
To obtain the component scores, simpy call: 
